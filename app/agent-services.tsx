...
const AgentServicesScreen = () => {
  ...
  const services = [
    {
      key: 'scoutingReport',
      title: i18n.t('agentScoutingReport'),
      description: i18n.t('agentScoutingReportDesc') + ' ' + i18n.t('agentScoutingReportPricing'),
      price: 'EGP 349',
      icon: 'document-text-outline',
    },
    {
      key: 'featuredPlayer',
      title: i18n.t('agentFeaturedPlayer'),
      description: i18n.t('agentFeaturedPlayerDesc') + ' ' + i18n.t('agentFeaturedPlayerPricing'),
      price: 'EGP 199',
      icon: 'star-outline',
    },
    {
      key: 'agentBundle',
      title: i18n.t('agentBundle'),
      description: null,
      price: 'EGP 399',
      special: true,
      payment: true,
      ...
      >
        <Animated.View style={{ flex: 1, opacity: fadeAnim }}>
          ...
          <View style={styles.header}>
            ...
            <View style={styles.headerContent}>
              <Text style={styles.headerTitle}>{i18n.t('agentAssistance') || 'Assistance & Extras'}</Text>
              <Text style={styles.headerSubtitle}>{i18n.t('boostYourAgency') || 'Boost your agency with premium services'}</Text>
            </View>
          </View>
          ...
          >
        <Text style={styles.intro}>{i18n.t('agentServicesIntro') || 'Boost your agency with our premium services:'}</Text>
        {services.map(service => (
            ...
            <Text style={[styles.serviceTitle, service.special && styles.specialTitle]}>{service.title}</Text>
                ...
                <Text style={[styles.serviceDesc, styles.specialDesc]}>{i18n.t('agentBundleIncludes')}</Text>
                    <View style={styles.bundleList}>
                      <Text style={[styles.serviceDesc, styles.specialDesc]}>• {i18n.t('agentBundleScouting')}</Text>
                      <Text style={[styles.serviceDesc, styles.specialDesc]}>• {i18n.t('agentBundleFeatured')}</Text>
                </View>
              </View>
            ) : (
