              ...
              {mediaList.map((media) => (
                <View key={media.id} style={styles.mediaCard}>
                  ...
                  <View style={styles.mediaInfo}>
                    ...
                    {media.content ? (
                      <Text style={styles.mediaCaption} numberOfLines={2}>{media.content}</Text>
                    ) : null}
...
const styles = StyleSheet.create({
  ...
  emptyText: { color: '#999', fontSize: 18, marginTop: 16 },
  ...
  mediaPreview: { width: 100, height: 100, borderRadius: 8, overflow: 'hidden', marginRight: 12 },
  ...
  videoLabel: { color: '#fff', fontSize: 12, marginTop: 4 },
  mediaInfo: { flex: 1 },
  mediaType: { fontSize: 16, fontWeight: '600', color: '#fff', marginBottom: 4 },
  mediaCaption: { fontSize: 14, color: '#ccc', marginBottom: 4 },
  mediaDate: { fontSize: 12, color: '#999' },
  actions: { flexDirection: 'row', gap: 8 },
  editButton: { padding: 8, borderRadius: 8, backgroundColor: 'rgba(78, 115, 223, 0.2)' },
  deleteButton: { padding: 8, borderRadius: 8, backgroundColor: 'rgba(231, 74, 59, 0.2)' },
  modalOverlay: {
    flex: 1,
